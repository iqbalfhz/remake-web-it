...
@section('content')
    ...
    @if (session('success') || session('error'))
        <div x-data="{ show: true }" x-show="show" x-cloak x-init="setTimeout(() => show = false, 4000)"
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-xl border mb-5 {{ session('error') ? 'bg-red-50 border-red-200 dark:bg-red-900/30 dark:border-red-700' : 'bg-emerald-50 border-emerald-200 dark:bg-emerald-900/30 dark:border-emerald-700' }}">
            @if (session('error'))
