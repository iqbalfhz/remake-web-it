...
@section('content')
    <div class="max-w-4xl">
        ...
        <form id="artikel-form" method="POST" action="{{ route('admin.artikel.store') }}" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
...
@push('scripts')
    ...
    <script>
        ...
        document.getElementById('image-input').addEventListener('change', function() {
            ...
            label.textContent = this.files[0] ? this.files[0].name : 'Klik untuk pilih gambar';
        });
    </script>
    <style>
